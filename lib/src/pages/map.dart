                  ...
                  child: Row(
                    ...
                    children: <Widget>[
                      ...
                      Column(
                        ...
                        children: <Widget>[
                          Helper.getPrice(Helper.getTotalOrdersPrice(order: _con.currentOrder), context, style: Theme.of(context).textTheme.headline4),
                          Text(
                            S.of(context)!.items + ':' + _con.currentOrder!.foodOrders!.length.toString(),
                            style: Theme.of(context).textTheme.caption,
                          ),
                        ],
                      ),
